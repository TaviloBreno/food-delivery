            ...
            <?php if (!empty($itens)): ?>
                            ...
                            <tbody>
                                <?php foreach ($itens as $id => $item): ?>
                                    <tr class="item-row">
                                        ...
                                        <td>R$ <?php echo number_format((float) ($item['preco'] ?? 0), 2, ',', '.'); ?></td>
                                        <td>
                                            <input type="number" name="quantidades[<?php echo $id; ?>]" class="form-control" value="<?php echo (int) ($item['quantidade'] ?? 1); ?>" min="1" style="max-width: 90px;">
                                        </td>
                                        <td class="price">R$ <?php echo number_format(((float) ($item['preco'] ?? 0)) * ((int) ($item['quantidade'] ?? 1)), 2, ',', '.'); ?></td>
                                        <td>
                ...
                <div class="row mt-4">
                    <div class="col-md-6">
                        ...
                        <p class="lead">R$ <?php echo number_format((float) $total, 2, ',', '.'); ?></p>
                    </div>
