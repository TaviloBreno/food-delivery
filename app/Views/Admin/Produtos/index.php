                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($produto->preco_promocional): ?>
                                                <span class="text-muted" style="text-decoration: line-through;">R$ <?php echo number_format($produto->preco, 2, ',', '.'); ?></span><br>
                            ...
                            <nav aria-label="Navegação de páginas">
                                <ul class="pagination-custom">
                                    <li class="page-item <?php echo $details['previous'] === null ? 'disabled' : ''; ?>">
                                        <a class="page-link" href="<?php echo $details['previous'] !== null ? site_url('admin/produtos?page=' . $details['previous'] . '&perPage=' . ($perPage ?? 10)) : '#'; ?>">
                                    ...
                                    if ($start > 1): ?>
                                        <li class="page-item">
                                            <a class="page-link" href="<?php echo site_url('admin/produtos?page=1&perPage=' . ($perPage ?? 10)); ?>">1</a>
                                        </li>
                                        <?php if ($start > 2): ?>
                                    ...
                                    <?php for ($i = $start; $i <= $end; $i++): ?>
                                        <li class="page-item <?php echo $i == $currentPage ? 'active' : ''; ?>">
                                            <a class="page-link" href="<?php echo site_url('admin/produtos?page=' . $i . '&perPage=' . ($perPage ?? 10)); ?>">
                                                <?php echo $i; ?>
                                            </a>
                                        </li>
                                    <?php endfor; ?>
                                    ...
                                    <?php if ($end < $pageCount): ?>
                                        ...
                                        <?php endif; ?>
                                        <li class="page-item">
                                            <a class="page-link" href="<?php echo site_url('admin/produtos?page=' . $pageCount . '&perPage=' . ($perPage ?? 10)); ?>">
                                                <?php echo $pageCount; ?>
                                            </a>
                                        </li>
                                    <?php endif; ?>
                                    ...
                                    <li class="page-item <?php echo $details['next'] === null ? 'disabled' : ''; ?>">
                                        <a class="page-link" href="<?php echo $details['next'] !== null ? site_url('admin/produtos?page=' . $details['next'] . '&perPage=' . ($perPage ?? 10)) : '#'; ?>">
